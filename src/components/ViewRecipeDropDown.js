              ...
              this.props.handleRecipeDropdownClick(
                ...
                // Instructions
                {
                  45: [
                    ...
                    "Gently Swirl",
                    "Let it bloom for 45s",
                  ],
                  70: ["Pour up to 100g total", "Pause for 10s"],
                  90: ["Pour up to 150g total", "Pause for 10s"],
                  110: ["Pour up to 200g total", "Pause for 10s"],
                  120: ["Pour up to 250g total", "Pause for 10s"],
                  125: ["Gently swirl"],
                  180: [
          ...
          <Dropdown.Item
            onClick={() =>
              this.props.handleRecipeDropdownClick(
                ...
                {
                  45: [
                    "Pre-wet with 60g water",
                    "Swirl brewer until the slurry is even",
                    "Bloom for up to 45 s",
                  ],
                  75: [
                    "Complete the first main pour till 300g in the next 30s",
                  ],
                  105: [
                    "Gently complete second main pour till 500g in the next 30s",
                  ],
                  135: [
                  ...
                  220: ["Aim to finish drawdown by 3min 30s"],
                }
              )
            }
          >
          ...
          <Dropdown.Item
            onClick={() =>
              this.props.handleRecipeDropdownClick(
                ...
                {
                  45: ["1st Pour: Add 60g of water", "Wait"],
                  90: ["2nd Pour: Add 60g of water", "Wait"],
                  135: ["3rd Pour: Add 60g of water", "Wait"],
                  180: ["4th Pour: Add 60g of water", "Wait"],
                  210: [
          ...
          <Dropdown.Item
            onClick={() =>
              this.props.handleRecipeDropdownClick(
                ...
                {
                  30: [
                    "Pour water from centre of the grounds, spiralling outwards",
                    "Let it pre-wet for 30s.",
                  ],
                  180: [
                    "Pour rest of the brew with same spiral motion",
                    "Avoid pouring on filter paper itself.",
                  ],
                }
              )
            }
